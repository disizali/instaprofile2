...
/* harmony import */ var _static_data_navies_json__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../static/data/navies.json */ "./static/data/navies.json");
var _static_data_navies_json__WEBPACK_IMPORTED_MODULE_11___namespace = /*#__PURE__*/__webpack_require__.t(/*! ../static/data/navies.json */ "./static/data/navies.json", 1);
...
function (_React$Component) {
  ...
  function Navy(props) {
    ...
    _this.state = {
      selected: _static_data_navies_json__WEBPACK_IMPORTED_MODULE_11__[0]
    };
    return _this;
  }
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(Navy, [{
    ...
    value: function changeAirPlane(e) {
      var selected = _static_data_navies_json__WEBPACK_IMPORTED_MODULE_11__[e.target.id.replace("navy-", "") - 1];
      this.setState({
        selected: selected
      });
    }
...
module.exports = JSON.parse("[{\"id\":1,\"number\":737,\"name\":\"Boeing\",\"persianName\":\"بوئینگ 737\",\"body\":\"بوئینگ 737 معروف به بچه‌بوئینگ، یک هواپیمای مسافربری باریک‌پیکر و تک‌راهرو ساخته شرکت بوئینگ آمریکا است. طراحی این هواپیما از 11 می 1964 آغاز شد و نخستین‌بار در 9 آوریل 1967 به پرواز درآمد.\"},{\"id\":2,\"number\":320,\"name\":\"Airbus\",\"persianName\":\"بوئینگ 737\",\"body\":\"هواپیماهای جدید ایرباس ۳۲۰ نئو بر پایه ی مدل قدیمی ‌تر خود که ایرباس آ ۳۲۰ نام داشت، توسعه و ساخته شد.\"}]");

/***/ })

})
//# sourceMappingURL=navy.js.3b24071b0694f60d1347.hot-update.js.map